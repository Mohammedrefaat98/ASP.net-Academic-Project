<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateAd.aspx.cs" Inherits="CreateAd" %>
...
<body style="align:left">
    ...
    <div style="background-color:rgba(255, 255, 255, .4);width:600px; height: 476px; border-radius: 25px">
    <form id="form1" runat="server" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
        ...
        <br>
        <p>&nbsp;&nbsp;Information*</p>
        &nbsp;<asp:TextBox ID="Information" runat="server"></asp:TextBox>
        <br>
        <p>&nbsp;&nbsp;Location*</p>
