<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Congratulations.aspx.cs" Inherits="Congratulations" %>
...
<body style="align:left">
    ...
    <form id="form1" runat="server" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
        <p style="font-size:40px; color:red">&nbsp;Your Response is done &nbsp;successfully</p>
        &nbsp;<asp:GridView ID="Event" runat="server" AutoGenerateColumns="False" align="center" Width="1016px" GridLines="Horizontal"  CssClass="cs" HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
                <Columns>
                    ...
                    <asp:BoundField DataField="event_notification_object_id" HeaderText="Notification Object ID" />
                    <asp:BoundField DataField="event_viewer_id" HeaderText="Viewer ID" />
                </Columns>
            </asp:GridView>
    </form></div>
</body>
