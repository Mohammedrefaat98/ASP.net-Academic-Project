<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditComment.aspx.cs" Inherits="EditComment" %>
...
<body style="align:left">
    ...
    <div style="background-color:rgba(255, 255, 255, .4);width:450px; height: 720px; border-radius: 25px">
    <form id="form1" runat="server" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
        <br>
        <p>&nbsp;&nbsp; Viewer ID*</p>
        &nbsp;<asp:TextBox ID="Viewer_id" runat="server"></asp:TextBox>
        <br>
        <p>&nbsp;&nbsp;Original Content ID*</p>
        &nbsp;<asp:TextBox ID="Original_Content_id" runat="server"></asp:TextBox>
        <br>
        <p>&nbsp;&nbsp;Last Writter Datetime*</p>
        &nbsp;<asp:TextBox ID="Last_Writter_Datetime" runat="server"></asp:TextBox>
        &nbsp;<asp:Label runat="server" Text="MM/DD/YYYY *" ForeColor="#ffff00" Font-Bold="true"/>
        <br>
        <p>&nbsp;&nbsp;Updated Writter Datetime*</p>
        &nbsp;<asp:TextBox ID="Updated_Writter_Datetime" runat="server"></asp:TextBox>
        &nbsp;<asp:Label runat="server" Text="MM/DD/YYYY *" ForeColor="#ffff00" Font-Bold="true"/>
        <br>
        <p>&nbsp;&nbsp;Text*</p>
        &nbsp;<asp:TextBox ID="Text1" runat="server" Height="121px" Width="304px"></asp:TextBox>
        <br>
        <br>
        &nbsp;<asp:Button ID="Button1" runat="server" Text="Edit" OnClick="Button1_Click" Width="71px" />
        <br>
