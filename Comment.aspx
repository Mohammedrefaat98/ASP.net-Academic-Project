...
<body style="align:left">
    ...
    <form id="form1" runat="server" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
        ...
        &nbsp;<asp:GridView ID="Event" runat="server" AutoGenerateColumns="False" align="center" Width="1168px" GridLines="Horizontal"  CssClass="cs" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" Height="366px">
                <Columns>
                    <asp:BoundField DataField="comment_Viewer_id" HeaderText="Viewer ID" />
                    <asp:BoundField DataField="comment_original_content_id" HeaderText="Original Content ID" />
