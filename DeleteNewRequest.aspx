<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteNewRequest.aspx.cs" Inherits="DeleteNewRequest" %>
...
<body style="align:left">
    ...
    <div style="background-color:rgba(255, 255, 255, .4);width:450px; height: 340px; border-radius: 25px">
    <form id="form1" runat="server" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
        <br>
        <p>&nbsp;&nbsp;New Request ID*</p>
        &nbsp;<asp:TextBox ID="request" runat="server"></asp:TextBox>
        <br>
        <br>
        &nbsp;<asp:Button ID="Button1" runat="server" Text="Delete" OnClick="Button1_Click" />
        <br>
        &nbsp;<asp:Label id="Label2" runat="server" Text="Note that if it doesn't be deleted, that means this new &nbsp;request is on the process by it's contributer " ForeColor="Red"/>
        <br>
        <br>
